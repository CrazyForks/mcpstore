...
## Status
**Currently after Phase 5** - PyO3 binding no longer uses the generic `to_py_object` path; next work should focus on deeper typed Rust core return shapes for resources/prompts/config/cache if needed.
